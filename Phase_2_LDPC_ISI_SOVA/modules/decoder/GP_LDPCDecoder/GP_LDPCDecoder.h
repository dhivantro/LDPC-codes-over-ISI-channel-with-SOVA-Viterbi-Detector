...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
  int **H;                            // LDPC matrix
  int N_col_H;                        // Number of column for H matrix
  int N_row_H;                        // Number of row for H matrix
  double **L;                         // log-likelihood ratios
  int N_col_L;                        // Number of column for L matrix
  int N_row_L;                        // Number of row for L matrix
